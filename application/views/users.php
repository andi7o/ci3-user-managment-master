					...
					<td>
						<div class="d-flex justify-content-center">
							<a href="<?php echo base_url('users/edit/' . $user->id) ?>">
								...
								<button type="submit" data-inline="true" id="deleteEmployeeModal" class="delete" data-toggle="modal"
										...
										<div class="modal-content">
											<form>
												...
												<div class="modal-footer">
													...
													<input type="submit" class="btn btn-danger" onclick="deleteUser <?= $user->id ?>" value="Delete">
												</div>
											</form>
										</div>
									</div>
